...
public:
  ...
  { 
    ...
    client3_ = this->create_client<turtlesim_composition::srv::Harmonic>("/harmonic");
...
private:
  ...
  void topic_callback(const turtlesim::msg::Pose::SharedPtr msg)
  {
    ...
    if(msg->x>9.0){
	    ...
	    auto request = std::make_shared<turtlesim_composition::srv::Harmonic::Request>();
	    request->pos = msg->x;
	    
	    using ServiceResponseFuture =
	    rclcpp::Client<turtlesim_composition::srv::Harmonic>::SharedFuture;
  ...
  rclcpp::Client<turtlesim_composition::srv::Harmonic>::SharedPtr client3_;
};
